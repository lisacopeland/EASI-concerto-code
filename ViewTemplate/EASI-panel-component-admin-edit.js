testRunner.component('adminEdit', {
  ...
  bindings: {},
  controller: function controller($scope, auth, $location) {
    ...
    $scope.genders = [
      ...
      { label: 'Neither Male nor Female', value: 'Neither Male nor Female' },
      { label: 'Prefer not to report', value: 'Prefer not to report' },
    ];
    $scope.highest_degrees = [
      { label: 'None', value: 'None' },
      { label: 'High School Diploma or Equivalent', value: 'High School Diploma or Equivalent' },
      { label: "Associate's Degree or Equivalent", value: "Associate's Degree or Equivalent" },
      { label: 'Bachelors Degree', value: 'Bachelors Degree' },
      { label: "Master's Degree or Equivalent", value: "Master's Degree or Equivalent" },
      { label: 'Doctoral (PhD) or Equivalent', value: 'Doctoral (PhD) or Equivalent' },
    ];
    $scope.professions = [
      { label: 'None', value: 'None' },
      { label: 'Occupational Therapist', value: 'Occupational Therapist' },
      { label: 'Physical Therapist/Physiatrist', value: 'Physical Therapist/Physiatrist' },
    ...
    this.$onInit = function () {
      $scope.refreshUserProfile().then(() => {
        ...
        if ($scope.user.expirationDate) {
          ...
          let weirdDateEliminator = new Date(
            'Thu Jan 01 2000 00:00:00 GMT-0700 (Mountain Standard Time)',
          );
          ...
          if ($scope.user.expirationDate === zeroDate) {
            // If user expirationDate equals zero date, don't show
            ...
            if (today > expireSoonDate) {
              // if today is after 3 months back from expiration date
