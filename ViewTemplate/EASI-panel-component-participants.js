testRunner.component('participants', {
  ...
  controller: function controller($scope, auth, participants, admin, $mdSidenav, $mdDialog, notif, $location, transFilter) {
    ...
    const now = new Date();
    $scope.filters = participants.filters ? participants.filters : {
      admin: {
        enabled: false,
        value: []
      },
